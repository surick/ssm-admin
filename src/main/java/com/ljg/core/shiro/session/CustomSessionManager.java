package com.ljg.core.shiro.session;
...
import com.ljg.core.shiro.CustomShiroSessionDAO;
import com.ljg.user.bo.UserOnlineBo;
/**
 * 
 * 用户Session 手动管理
 *
...
public class CustomSessionManager {
	 ...
	 * session status 
	 */
	public static final String SESSION_STATUS ="ljg-online-status";
